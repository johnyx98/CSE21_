public class Lab21_Objects {
	...
	public static void main(String[] args) {
		...
		dlist[5] = new Dummy(dlist[6]);
		
		dlist[6] = new Dummy(dlist);
		
		dlist[7] = new Dummy(iarr[8], darr[8]);
		
		dlist[8] = new Dummy(iarr, darr);
		
		dlist[9] = new Dummy(iarr[10], darr[10], dlist[10]);
		...
		dlist[5].display(dlist[6]);
		
		dlist[6].display(dlist);
		
		dlist[7].display(iarr[8], darr[8]);
		
		dlist[8].display(iarr, darr);
		
		dlist[9].display(iarr[10], darr[10], dlist[10]);
